...
- **collected_at**: 2026-07-20T01:27:18
...
| --- | --- | --- | --- | --- | --- |
| 512x512<br>4steps | Text Encoder-INT4 | 1.603s | 0.203s | 3.41GB | 3.73GB |
|  | Transformer-INT4 | 1.314s | 1.543s | 3.45GB | 3.48GB |
|  | Small VAE Decoder-FP16 | 0.073s | 0.131s | 0.05GB | 0.08GB |
| 1024x1024<br>4steps | Text Encoder-INT4 | 1.636s | 0.233s | 3.83GB | 4.15GB |
|  | Transformer-INT4 | 1.314s | 6.144s | 3.88GB | 3.92GB |
|  | Small VAE Decoder-FP16 | 0.073s | 0.909s | -0.11GB | 1.65GB |
...
- int4 512x512: image saved to benchmark_outputs_ov_matrix\ov_26_2\images\flux2_klein_int4_512x512_4steps_no_cfg.png
- int4 1024x1024: image saved to benchmark_outputs_ov_matrix\ov_26_2\images\flux2_klein_int4_1024x1024_4steps_no_cfg.png
